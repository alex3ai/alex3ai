...
Bem-vindo ao meu perfil! Graduado em Engenharia Elétrica, atualmente concluindo minha segunda graduação em Ciência de Dados pela FATEC.

Sou um entusiasta da tecnologia, focado em aplicar minha sólida base analítica para transformar dados complexos em insights e soluções acionáveis.
...
* **Deep Learning, Visão Computacional & PLN:** Desenvolvimento de redes neurais avançadas (CNNs, RNNs) com PyTorch e TensorFlow para análise de imagens e texto (como Classificação de Sentimentos).
